...
| Filtrar lista de usuarios por email/phone | ⚠️ No implementado | Requiere desarrollo |
...
### 2. Obtener Perfiles de Usuario (GET /api/analytics/user-profiles/:site)

Lista todos los usuarios identificados con email/phone.

**Request:**
```
GET /api/analytics/user-profiles/1?limit=100&offset=0
```
